...
//AudioPlayer player;
//Minim minim;
SoundFile gameOver, blockPlaced, rowCleared, bgm;
...
void setup() {
  ...
  "background_onlineConv.mp3"
  );
  blockPlaced = new SoundFile(this, "blockPlaced.wav");
  blockPlaced.amp(0.2);
  rowCleared= new SoundFile(this, "clearRow.wav");
  rowCleared.amp(0.4);
